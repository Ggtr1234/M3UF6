...
public class Track {
    ...
    public int creaTrack(String nom, Album album, MediaType mediaType, Genre genre, String composer, int milliseconds, int bytes, int unitPrice) {
        Statement stmt = null;
        int idTrackNew = -1;
        try {
            ...
            String query = "INSERT INTO Track (Name,AlbumId,MediaTypeId,GenreId,Composer,Miliseconds,Bytes,UnitPrice) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
